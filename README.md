...
chapter 2! numbers
To do over the week
also - come hang on Sat.
create your own folder called “this”, file “this” and running that file. Do 2.5 questions inside the folder!
Here are some commands to take home with you.

Class 2.
Review h-work and command line!
Strings (letters) and Variables and Assignment. Up till 5.3. Stop at Methods.
To do over the week
We’ll create an assignment!! #s, strings, variables.
review command line again
show the error messages to expect!!
 -->
